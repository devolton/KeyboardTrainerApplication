...
{
    public interface ILearnPageModel
    {
        ...
        ImageSource GetKeyboardSchemeEngImageSource();
        ImageSource GetStartLeftEngPositionImageSource();
        ImageSource GetStartRightEngPositionImageSource();
