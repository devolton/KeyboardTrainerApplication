...
namespace Encrypter
{
    ...
    {
        private string _keyForZero;
        private BitArray _xorBitArrayForThirdBlock;
        private BitArray _xorBitArrayForSecondBlock;
        private Dictionary<int, int> _oneBytePermutationIndexDict;
        private Dictionary<int, int> _twoBytePermutationIndexDict;
        private StringBuilder _sb;
        private int _Key { get; set; }
        private bool _IsStrKey { get; set; }
        private DevoltonEncrypter()
        {
        ...
        private static DevoltonEncrypter _SingleEncrypter { get; set; }
        public static DevoltonEncrypter GetInstance()
        {
            if (_SingleEncrypter == null)
            {
                _SingleEncrypter = new DevoltonEncrypter();
            }
            return _SingleEncrypter;
        }
